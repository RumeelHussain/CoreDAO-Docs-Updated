...
Siga nuestra guía detallada sobre cómo conectar su billetera MetaMask al Core [Testnet](/i18n/es/docusaurus-plugin-content-docs/current/Dev-Guide/core-testnet-wallet-config.md) y [Mainnet](/i18n/es/docusaurus-plugin-content-docs/current/Dev-Guide/core-mainnet-wallet-config.md).
