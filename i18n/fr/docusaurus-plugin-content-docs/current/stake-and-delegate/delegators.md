...
2. **Délégation de la Puissance de Hachage par les Mineurs de BTC :**
   ...
   - **Comment déléguer du Hash :** Core permet aux mineurs de BTC de déléguer leur puissance de hachage aux validateurs sur Core, leur permettant de gagner des récompenses de staking de l'écosystème Core sous forme de tokens CORE supplémentaires. Pour plus de détails, consultez le guide détaillé sur la [façon de déléguer la puissance de hachage aux validateurs Core](/i18n/fr/docusaurus-plugin-content-docs/current/stake-and-delegate/delegating-hash.md).
